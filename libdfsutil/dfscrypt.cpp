 ...
 */
std::string OriCrypt_MD5String(const string &str)
{
    MD5_CTX state;
    stringstream rval;
...
ObjectHash OriCrypt_HashString(const string &str)
{
 ...
 */
string OriCrypt_Encrypt(const string &plaintext, const string &key)
{
    int bits, clen, flen;
 ...
 * ciphertext blob.
 */
string OriCrypt_Decrypt(const string &ciphertext, const string &key)
{
    int bits, plen, flen;
