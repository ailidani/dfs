...
void Index::open(const string &indexFile)
{
    int i, entries;
    struct stat sb;
...
void Index::updateEntry(const ObjectHash &objId, const IndexEntry &entry)
{
...
const IndexEntry& Index::getEntry(const ObjectHash &objId) const
{
...
const ObjectInfo& Index::getInfo(const ObjectHash &objId) const
{
    return getEntry(objId).info;
}

bool Index::hasObject(const ObjectHash &objId) const
{
...
void Index::_writeEntry(const IndexEntry &e)
{
    strwstream ss;
