...
bool Packfile::receive(bytestream *bs, Index *idx)
{
...
Packfile::sp PackfileManager::getPackfile(packid_t id)
{
...
Packfile::sp PackfileManager::newPackfile()
{
...
bool PackfileManager::hasPackfile(packid_t id)
{
...
vector<packid_t> PackfileManager::getPackfileList()
{
...
void PackfileManager::_recomputeFreeList()
{
    vector<packid_t> existing;
    DirIterate(rootPath.c_str(), &existing, _freeListCB);
...
bool PackfileManager::_loadFreeList()
{
...
void PackfileManager::_writeFreeList()
{
    strwstream ss;
...
string PackfileManager::_getPackfileName(packid_t id)
{
    stringstream ss;
    ss << rootPath;
    ss << "pack";
