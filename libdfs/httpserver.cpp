...
static void HTTPServerLogCB(int severity, const char *msg)
{
#ifdef DEBUG
    const char *sev[] = {
...
void HTTPServerReqHandlerCB(struct evhttp_request *req, void *arg)
{
...
void HTTPServer::start(bool mDNSEnable)
{
...
void HTTPServer::entry(struct evhttp_request *req)
{
...
int HTTPServer::authenticate(struct evhttp_request *req, struct evbuffer *buf)
{
    int n;
    char output[64];
...
void HTTPServer::stop(struct evhttp_request *req)
{
    struct evbuffer *buf;
...
void HTTPServer::getId(struct evhttp_request *req)
{
...
void HTTPServer::getVersion(struct evhttp_request *req)
{
...
void HTTPServer::head(struct evhttp_request *req)
{
...
void HTTPServer::getIndex(struct evhttp_request *req)
{
    DLOG("httpd: getindex");
...
void HTTPServer::getCommits(struct evhttp_request *req)
{
...
void HTTPServer::contains(struct evhttp_request *req)
{
    // Get object hashes
...
void HTTPServer::getObjs(struct evhttp_request *req)
{
    // Get object hashes
    evbuffer *buf = evhttp_request_get_input_buffer(req);
    evbufstream in(buf);
...
void HTTPServer::getObjInfo(struct evhttp_request *req)
{
    string url = evhttp_request_get_uri(req);
    string sObjId;
