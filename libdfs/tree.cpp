...
bool TreeEntry::isTree()
{
    return type == Tree;
}

void TreeEntry::extractToFile(const std::string &filename, Repo *src) const
{
    ASSERT(type != Null);
